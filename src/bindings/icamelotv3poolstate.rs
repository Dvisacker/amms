...
```*/
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for ICamelotV3PoolStateCalls {
        const NAME: &'static str = "ICamelotV3PoolStateCalls";
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                &[u8],
                bool,
            ) -> alloy_sol_types::Result<ICamelotV3PoolStateCalls>] = &[
                {
                    fn tickTable(
                        data: &[u8],
                        validate: bool,
                        ...
                        <tickTableCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ICamelotV3PoolStateCalls::tickTable)
                    }
                    tickTable
                },
                {
                    fn ticks(
                        ...
                        <ticksCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ICamelotV3PoolStateCalls::ticks)
                    }
                    ticks
                },
            ];
    ...
    /**Creates a new wrapper around an on-chain [`ICamelotV3PoolState`](self) contract instance.

See the [wrapper's documentation](`ICamelotV3PoolStateInstance`) for more details.*/
    #[inline]
    pub const fn new<
    ...
    >(
        ...
        provider: P,
    ) -> ICamelotV3PoolStateInstance<T, P, N> {
        ICamelotV3PoolStateInstance::<T, P, N>::new(address, provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    >(
        ...
        Output = alloy_contract::Result<ICamelotV3PoolStateInstance<T, P, N>>,
    > {
        ICamelotV3PoolStateInstance::<T, P, N>::deploy(provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(provider: P) -> alloy_contract::RawCallBuilder<T, P, N> {
        ICamelotV3PoolStateInstance::<T, P, N>::deploy_builder(provider)
    }
    /**A [`ICamelotV3PoolState`](self) instance.

Contains type-safe methods for interacting with an on-chain instance of the
[`ICamelotV3PoolState`](self) contract located at a given `address`, using a given
provider `P`.
...
See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct ICamelotV3PoolStateInstance<T, P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network_transport: ::core::marker::PhantomData<(N, T)>,
    }
    #[automatically_derived]
    impl<T, P, N> ::core::fmt::Debug for ICamelotV3PoolStateInstance<T, P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("ICamelotV3PoolStateInstance").field(&self.address).finish()
        }
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        ...
        pub async fn deploy(
            provider: P,
        ) -> alloy_contract::Result<ICamelotV3PoolStateInstance<T, P, N>> {
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    impl<T, P: ::core::clone::Clone, N> ICamelotV3PoolStateInstance<T, &P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> ICamelotV3PoolStateInstance<T, P, N> {
            ICamelotV3PoolStateInstance {
