 ...
 */
contract GetCamelotV3TickDataBatchRequest {
    ...
    constructor(address pool, bool zeroForOne, int24 currentTick, uint16 numTicks, int24 tickSpacing) {
        ...
        while (counter < numTicks) {
            ...
            (, int128 liquidityNet,,,,,,) = ICamelotV3PoolState(pool).ticks(nextTick);
        ...
        returns (int24 next, bool initialized)
    {
        unchecked {
            ...
            if (lte) {
                ...
                uint256 masked = ICamelotV3PoolState(pool).tickTable(wordPos) & mask;
